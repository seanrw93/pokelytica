...
// import { HeuristicAI } from '@/lib/simulate';
...
Based on the win statistics, team compositions, and the battle log above, provide:
1. **Win Probability** — summarize the matchup odds
2. **Strengths** — what gives the winning team its edge, referencing specific moments from the log
3. **Weaknesses** — what holds the losing team back, referencing specific moments from the log
